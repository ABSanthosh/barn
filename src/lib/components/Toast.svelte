<script lang="ts">
	import type { IToast } from '$lib/Store/ToastStore';
	import { backInOut } from 'svelte/easing';
	import { fly } from 'svelte/transition';
	export let { message, dir = 'bottom', timeout, type = 'default', id } = $$props as IToast;
</script>
...
<span
	...
	data-type={type}
	data-dir={dir}
	transition:fly={{ y: dir === 'top' ? -50 : 50, duration: 500, easing: backInOut }}
>
	{message}
</span>
